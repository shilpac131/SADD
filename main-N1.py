...
NETWORK - 1 : FROZE AASIST AND PROCESS FRAME WISE BATRA WITH LSTM without batch normalization'''
...
from batra_model import Batra_N1_Transformer
from data_utils import (Dataset_ASVspoof2019_train_spk,
                        Dataset_ASVspoof2019_devNeval_spk, genSpoof_list_spk,Dataset_ASVspoof2019_devNeval_ablation,
                        Dataset_ASVspoof2019_devNeval_ablation2)
...
def main(args: argparse.Namespace) -> None:
    ...
    model_tag = "LPC_aasist_batra_N1_trans_batch24"
    # if args.comment:
    ...
    # eval_score_path = "/home/s22004/research/aasist_batra/results_ablation/Abl-N1-same-tar.txt"
    ...
    ## load saved weights from AASIST - 0.83 EER and freeze it 
    saved_weights = torch.load('/users/home/s22004/research/aasist_batra_frameswise/models/weights/AASIST.pth')
    model.load_state_dict(saved_weights)
    # Set requires_grad to False for all parameters in BATRA
    for param in model.parameters():
        param.requires_grad = False
    print("AASIST model loaded")

    # define model architecture - BATRA-N1
    model2 = Batra_N1_Transformer().to(device) # replave LSTM for transformer
    ...
    if args.eval:
        ...
        calculate_tDCF_EER(cm_scores_file=eval_score_path,
                           ...
                           output_file="/home/s22004/research/aasist_batra/results_ablation/EER-Abl-N1-same-tar.txt")
        # print("DONE.")
        # eval_eer, eval_tdcf = calculate_tDCF_EER(
        #     cm_scores_file=eval_score_path,
        #     asv_score_file=database_path / config["asv_score_path"],
        #     output_file=model_tag / "Ablation-t-DCF_EER.txt")
        sys.exit(0)

    # get optimizer and scheduler
    optim_config["steps_per_epoch"] = len(trn_loader)
    # optimizer, scheduler = create_optimizer(model.parameters(), optim_config)
    optimizer, scheduler = create_optimizer(model2.parameters(), optim_config) ## FOR BATRA
    ...
    for epoch in range(config["num_epochs"]):
        ...
        ## !!!!CAUTION !!!!need to save only BATRA model, as AASIST is frozen. during eval just take frozen AASIST(0.83EER) and saved "MODEL 2"
        ...
        ## write in a log file
        with open("/users/home/s22004/research/aasist_batra_frameswise_without_BN/training_logN1_trans_batch24.txt", "a") as f1:
...
def get_loader(
    ...
    train_set = Dataset_ASVspoof2019_train_spk(list_IDs=file_train,
    ...
    dev_set = Dataset_ASVspoof2019_devNeval_spk(list_IDs=file_dev,
    ...
    eval_set = Dataset_ASVspoof2019_devNeval_spk(list_IDs=file_eval,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config",
                        ...
                        default="/home/s22004/research/aasist_batra_frameswise_without_BN/config/AASIST-N1.conf")
    parser.add_argument(
        "--output_dir",
        dest="output_dir",
        type=str,
        help="output directory for results",
        default="/DATA2/s22004_local/batra_framewise_aasist_without_BN",
    )
